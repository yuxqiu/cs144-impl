...
class Router {
    ...
    //! The <IP, prefix_len> => <# of Interface, Address>
    std::map<std::pair<uint32_t, uint8_t>, std::pair<size_t, std::optional<Address>>> table_{};
  ...
  public:
    ...
    AsyncNetworkInterface &interface(const size_t N) { return interfaces_.at(N); }
